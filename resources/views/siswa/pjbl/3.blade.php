    ...
    <section class="w-full h-400 bg-white shadow-md rounded-none p-8 mt-2 relative">
        <div class="flex flex-col lg:flex-row items-center lg:justify-between">
            ...
            <div class="lg:w-1/2 text-center lg:text-left">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Pembagian Penugasan Kelompok 1</h2>
                <!-- Isi Studi Kasus -->
                ...
                <!-- Tombol Next -->
                <div class="mt-4">
                    <a href="/siswa/pjbl/4" class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-6 rounded-md transition">
                        Next →
                    </a>
                </div>
            </div>
    ...
    <section class="container mx-auto px-2 lg:px-20 py-12 bg-white rounded-md">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col text-left">
                ...
                <a href="#" class="mt-6 px-6 py-2 bg-purple-600 text-center text-white font-semibold rounded-lg shadow-md hover:bg-purple-700 transition duration-300">
                    Atur Penugasan
                </a>
            </div>
