    ...
    <section class="w-full h-400 bg-white shadow-md rounded-none p-8 mt-2 relative">
        <div class="flex flex-col lg:flex-row items-center lg:justify-between">
            ...
            <div class="lg:w-1/2 text-center lg:text-left">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Menyusun Rencana Projek Kelompok 1</h2>
                <!-- Isi Studi Kasus -->
                ...
                <!-- Tombol Next -->
                <div class="mt-4">
                    <a href="/siswa/pjbl/3" class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-6 rounded-md transition">
                        Next →
                    </a>
                </div>
            </div>
