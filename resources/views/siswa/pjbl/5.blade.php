...
<x-layout-siswa>
    ...
    <section class="w-full h-400 bg-white shadow-md rounded-none p-8 mt-2 relative">
        <div class="flex flex-col lg:flex-row items-center lg:justify-between">
            ...
            <div class="lg:w-1/2 text-center lg:text-left">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Pengumpulan Project Kelompok 1</h2>
                <!-- Isi Studi Kasus -->
                ...
                <!-- Tombol Next -->
                {{-- <div class="mt-4">
                    <a href="/siswa/pjbl/6" class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-6 rounded-md transition">
                        Next →
                    </a>
                </div> --}}
            </div>
    ...
    <div class="w-full h-400 bg-white shadow-md rounded-none p-8 mt-2 relative">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Rumusan Masalah</h2>
        <p class="text-gray-700 text-lg leading-relaxed mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Indikator Penyebab Masalah</h2>
        <p class="text-gray-700 text-lg leading-relaxed mb-6">
            Anda diminta untuk mencari Indikator Penyebab Masalah dari studi kasus yang telah diberikan. Carilah Indikator Masalah yang bisa kamu dapatkan dari studi kasus tersebut.
        </p>
        {{-- <input type="text" id="rumusan-masalah" class="border-2 border-gray-300 p-3 w-full mt-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan rumusan masalah..."> --}}
    ...
    <section class="container mx-auto px-2 lg:px-10 py-12 bg-white rounded-md">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-3xl font-bold text-gray-800 text-left">Penugasan</h2>
            {{-- <button onclick="toggleModal(true)" class="bg-purple-600 text-white pr-4 pl-2 py-2 rounded-md hover:bg-purple-700 transition">+ Tambah Penugasan</button> --}}
        </div>
        ...
        <div class="mt-8 w-full justify-center">
            <div class="flex flex-col items-center">
                <!-- Input File -->
                <input type="file" class="border-2 border-gray-300 p-3 w-full mt-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                <!-- Button -->
                <a href="/siswa/pjbl/6" class="mt-6 px-6 py-2 bg-purple-600 text-center text-white font-semibold rounded-lg shadow-md hover:bg-purple-700 transition duration-300">
                    Atur Penugasan
                </a>
            </div>
        </div>
