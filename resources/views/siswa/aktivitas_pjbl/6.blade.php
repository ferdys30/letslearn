    ...
    <section class="w-full h-400 bg-white shadow-md rounded-none p-8 mt-2 relative">
        <div class="flex flex-col lg:flex-row items-center lg:justify-between">
            ...
            <div class="lg:w-1/2 text-center lg:text-left">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">pengumpulan_tugas File Presentasi kelompok_pjbl 1</h2>
                <!-- Isi Studi Kasus -->
                ...
                <!-- Button Kumpulkan -->
                <div class="mt-8">
                    <a href="/siswa/aktivitas_pjbl/7" class="block text-center px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg shadow-md hover:bg-purple-700 transition duration-300">
                        Kumpulkan
                    </a>
                </div>
            </div>
