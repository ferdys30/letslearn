...
<x-layout-siswa>
    ...
    @if($kuisList->isEmpty())
        <div class="mt-10 text-center text-gray-500">
            <p class="text-lg">Belum ada kuis tersedia untuk mata pelajaran <strong>{{ $mapel->nama_mapel ?? '' }}</strong>.</p>
        </div>
    @else
                    ...
                    <div x-show="tab === '{{ $kuis->id }}'">
                        ...
                        @else
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <a href="{{ route('siswa.kelas.kuis.show', ['mapel' => $mapel->slug, 'kuis' => $kuis->id]) }}"
